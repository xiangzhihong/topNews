package xzh.com.wangyinews.http;
...
public class ApiHttpClient {
    ...
    public final static String HOST = "www.google.com";
    private static String API_URL = "http://www.google.com/%s";
    
    public final static String HOST_LOCAL = "http://ic.snssdk.com/article/";
    private static String API_URL_LOCAL = "category/get_extra/v1/";
